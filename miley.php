...
<?php
$jsonurl = "http://otter.topsy.com/searchcount.json?q=tony%20martin&type=tweet";
...
<div style="position:relative; width:0px; height:400px; top:-233px; margin-bottom:-300px;"><div style="position:absolute; width:1230px; height:190px; padding: 127px 10px 10px 10px; background:url(http://sporttest.mcsaatchi.com/twittergames/images/website13.jpg) no-repeat center; border: 1px solid #e4e4e4; top:0px; left:50%;">
...
<td style="height:200px">
 <a class="css3button1" style="float:right; font-size:25px; color:#444; width:345px; display: block; border: 1px solid #ccc;  position:relative;" href="https://twitter.com/share?text=I've%20just%20tweeted%20for%20Bradley%20%23Wiggins%20in%20%23GamesTweets%20via%20@MCSaatchiSandE&amp;url=http%3A%2F%2Fwiggins.gamestweets.com&amp;related=MCSaatchiSandE" target="_blank"><img src="http://sporttest.mcsaatchi.com/twittergames/images/vsbird1.png" style="position:absolute; top:28px; left:20px;" />Tweet <span style="color:#16277f;">#Wiggins</span>
  <span class="warn" style="position:absolute; bottom:-34px; color:#999; font-size:11px; display:block; width:460px; left:0; text-align:center;">Tweet for Bradley Wiggins!</span></a>
</td>
<td>
 <a class="css3button2" style="float:right; font-size:25px; color:#444; width:345px; display: block; border: 1px solid #ccc;  position:relative;" href="https://twitter.com/share?text=I've%20just%20tweeted%20for%20Tony%20%23Martin%20in%20%23GamesTweets%20via%20@MCSaatchiSandE&amp;url=http%3A%2F%2Fwiggins.gamestweets.com&amp;related=MCSaatchiSandE" target="_blank"><img src="http://sporttest.mcsaatchi.com/twittergames/images/vsbird2.png" style="position:absolute; top:28px; left:20px;" />
 <span style="color:#999999;">Tweet </span> <span style="color:#ffffff;">#Martin</span>
  <span class="warn" style="position:absolute; bottom:-34px; color:#999; font-size:11px; display:block; width:460px; left:0; text-align:center;">Tweet for Tony Martin!</span></a>
</td>
</tr>
<tr>
<td>
...
.twtr-widget .twtr-tweet{border:none; margin-bottom:20px;}
 ...
 <div style="width:440px; float:left; margin:30px 0 0 0;">
       ...
       <h2 style="font-family: Helvetica; color:#333; border-bottom:1px solid #dddddd; padding:0 0 20px 0; margin:0 0 10px 0; position:relative;">Mentions of #Bradley Wiggins <span style="position:absolute; right:0; color:#999;"><?php echo $hash_Bolt; ?></span></h2>
...
new TWTR.Widget({
  ...
  search: 'Bradley Wiggins olympics',
...
<div style="width:440px; float:right;  margin:30px 0 0 0;">
         ...
         <h2 style="font-family: Helvetica; color:#333; border-bottom:1px solid #dddddd; padding:0 0 20px 0; margin:0 0 10px 0; position:relative;">Mentions of #Tony Martin <span style="position:absolute; right:0; color:#999;"> <?php echo $hash_Blake; ?> </span></h2>
