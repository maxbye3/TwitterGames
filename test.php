...
<meta charset="UTF-8">
<!--[if IE]><![endif]-->
<title>Kellie Wells vs Sally Pearson </title>
<style>
body {
width: 990px;
color: #000;
...
<div id="table" style="position:relative; width:1500px;  margin:0 0 0 0;">
 <table style="float: left;">
        ...
        <div id="MCSaatchi_header"><img border="0" src="images/mc3.png" /></div>
        </a>
...
<!-- Start Here! and change the image -->
<div style="position:relative; width:0px; height:400px; top:-233px; margin-bottom:-300px;"><div style="position:absolute; width:1230px; height:190px; padding: 127px 10px 10px 10px; background:url(http://sporttest.mcsaatchi.com/twittergames/header_images/Wells_main.png) no-repeat center; border: 1px solid #e4e4e4; top:0px; left:50%;">

 
<?php
$jsonurl = "http://otter.topsy.com/searchcount.json?q=Sally%20Pearson&type=tweet";
...
<?php
$jsonurl = "http://otter.topsy.com/searchcount.json?q=Kellie%20Wells&type=tweet";
$json = file_get_contents($jsonurl,0,null,null);
$json_output = json_decode($json, true);
?>
...
<td style="height:200px">
 <a class="css3button1" style="margin-left: auto; margin-right: auto; font-size:25px; color:#444; width:100px; display: block; border: 1px solid #ccc;  position:relative;" href="https://twitter.com/share?text=I've%20just%20tweeted%20for%20Kellie%20%23Wells%20in%20%23GamesTweets%20via%20@MCSaatchiSandE&amp;url=http%3A%2F%2FWells.gamestweets.com&amp;related=MCSaatchiSandE" target="_blank"><img src="http://sporttest.mcsaatchi.com/twittergames/images/vsbird1.png" style="position:absolute; top:36px; left:30px;" /> <span style="color:#16277f;">#Wells</span>
  <span class="warn" style="margin-left: auto; margin-right: auto; position:absolute; bottom:-34px; color:#999; font-size:11px; display:block; width:460px; left: -115px;">Tweet for Kellie Wells!</span></a>
</td>
<td>
 <a class="css3button2" style="margin-left: auto; margin-right: 20%; font-size:25px; color:#444; width:100px; display: block; border: 1px solid #ccc;  position:relative;" href="https://twitter.com/share?text=I've%20just%20tweeted%20for%20Pau%20%23Gasol%20in%20%23GamesTweets%20via%20@MCSaatchiSandE&amp;url=http%3A%2F%2Fgasol.gamestweets.com&amp;related=MCSaatchiSandE" target="_blank"><img src="http://sporttest.mcsaatchi.com/twittergames/images/vsbird2.png" style="position:absolute; top:34px; left:30px;" />
 <span style="color:#ffffff;">#Gasol</span>
  <span class="warn" style="position:absolute; bottom:-34px; color:#999; font-size:11px; display:block; width:460px; left:-110px; text-align:center;">Tweet for Pau Gasol!</span></a>
</td>
</tr>
<tr>
<td>
...
.twtr-widget .twtr-tweet{border:none; margin-bottom:20px;}
 ...
 <div style="width:440px; float:left; margin:30px 0 0 0;">
       ...
       <h2 style="font-family: Helvetica; color:#333; border-bottom:1px solid #dddddd; padding:0 0 20px 0; margin:0 0 10px 0; position:relative;">Mentions of #Kellie Wells <span style="position:absolute; right:0; color:#999;"><?php echo $hash_Bolt; ?></span></h2>
...
<div style="width:440px; float:right;  margin:30px 0 0 0;">
         ...
         <h2 style="font-family: Helvetica; color:#333; border-bottom:1px solid #dddddd; padding:0 0 20px 0; margin:0 0 10px 0; position:relative;">Mentions of #Sally Pearson <span style="position:absolute; right:0; color:#999;"> <?php echo $hash_Blake; ?> </span></h2>
...
<script>
 ...
 <table style="float:left; padding-top: 15px;">
        ...
        <th>
          <a href="http://Pearson.gamestweets.com" target="_blank">
         <img border="0" src="images/small4.jpg" width="400"/>
        </a>
        </th>
         <th>
